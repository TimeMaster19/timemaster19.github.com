<?php
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->SMTPAuth = true;
		$mail->SMTPSecure = 'tls';//tipo de seguridad, con Gmail TLS

		//Agregado para deshabilitar la verificacion ssl de PHP 5.6
		...
		$mail->Username = 'dark.mirror.19@gmail.com';
		$mail->Password = 'time-master.life';
		
		$mail->setFrom('dark.mirror.19@gmail.com', 'Sistema de Usuarios');
