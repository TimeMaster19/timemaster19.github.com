<?php
	...
	if(!empty($_POST)){
		//comienzo a recebir los valores en variables del método POST
		$nombre = $mysqli->real_escape_string($_POST['nombre']);//limpia el string y evita SQLInjection
		...
		if(!$captcha){
			$errors[] = "Por favor verificar captcha";
		}

		//validación de campos para evitar qeu quiten la validación del elemento por lado del server
		//utilizo las validaciones en el archivo funcs.php
		if(isNull ($nombre, $usuario, $password, $con_password, $email)){
			$errors[] = "Debe llenar todos los campos";
		}

		if (!isEmail ($email)) {
			$errors[] = "Debe ser un email valido";
		}
		...
		//validacion de existentes en Mysqli
		if (usuarioExiste($usuario)) {
			$errors[] = "El nombre del ususario $usuario ya existe";
		}
					...
					<div class="panel-body" >
						...
						<form id="signupform" class="form-horizontal" role="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" autocomplete="off">
							...
							<div class="form-group">
								...
								<div class="g-recaptcha col-md-9" data-sitekey="6Lc0o14UAAAAAEmD2HD09CGR63NjD12_RRiJnEpX"></div>
							</div>
